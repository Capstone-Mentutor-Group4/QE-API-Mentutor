...
#    And Validate json schema add comment by mentor
  ...
  @Test @Mentor @Status @Positive-Case #MNTR-060
  ...
  @Test @Mentor @Status @Negative-Case #MNTR-061
  ...
  @Test @Mentor @Status @Negative-Case #MNTR-062
  ...
  @Test @Mentor @Status @Positive-Case #MNTR-063
  ...
  @Test @Mentor @Status @Positive-Case #MNTR-064
  ...
  @Test @Mentor @Status @Negative-Case #MNTR-065
